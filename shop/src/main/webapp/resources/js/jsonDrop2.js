...
var select_cateCodeRef = "${category.cateCodeRef}";
var select_cateName = "${category.cateName}";

//이럴 때 확인차 console..
console.log("select_cateCode = " + select_cateCode);
console.log("select_cateCodeRef = " + select_cateCodeRef);
console.log("select_cateName = " + select_cateName);

if(select_cateCodeRef != null && select_cateCodeRef != ""){
	//select_cateCodeRef 비어있는 문자열도 아니고 여백 문자열도 아닌지 확인
	...
	$(".category2").append("<option value='" + select_cateCode + "'selected>전체</option>");
}
